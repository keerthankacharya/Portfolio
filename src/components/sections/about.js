...
const About = () => {
  ...
  const skills = ['JavaScript (ES6+)', 'TypeScript', 'React.js', 'Express.js', 'Node.js', 'MongoDB'];
    ...
    <StyledAboutSection id="about" ref={revealContainer}>
      ...
      <div className="inner">
        <StyledText>
          <div>
            <p>
              Hi! I'm a web developer passionate about creating responsive, user-friendly digital experiences. I work with React, TypeScript, 
